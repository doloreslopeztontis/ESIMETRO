CREATE DATABASE  IF NOT EXISTS `esimetro_db` /*!40100 DEFAULT CHARACTER SET latin1 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `esimetro_db`;
...
INSERT INTO `preguntas` VALUES (1,6,'¿Quién escribió La Odisea?','Es un gran poema que fue escrito por Homero'),(2,6,'¿Qué artista pintó \"Baco\"?','Muy linda pintura');
...
INSERT INTO `respuestas` VALUES (1,1,'Homero',100),(1,2,'Rembrandt',0),(2,1,'Eduardo Galeano',0),(2,2,'Rubens',0),(3,1,'Borges',0),(3,2,'Caravaggio',100),(4,1,'Maria Elena Walsh',0),(4,2,'Renoir',100);
...
/*!50003 DROP PROCEDURE IF EXISTS `insertar_Estadistica` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertar_Estadistica`(IN id_usuario INT, IN id_pregunta INT, IN id_respuesta INT)
BEGIN
	INSERT INTO estadisticas (usuario, idPregunta, idRespuesta, fecha_hora) VALUES (id_usuario, id_pregunta, id_respuesta, NOW());
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `traer_UltimaEstadistica` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `traer_UltimaEstadistica`(OUT idusuario INT)
BEGIN
...
-- Dump completed on 2019-07-14 13:17:25
